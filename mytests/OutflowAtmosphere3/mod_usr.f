...
contains
  ...
  subroutine initial_conditions(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
    ...
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,rho_) = w(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,rho_)*(one+1.d-2*rand(ixOmin1:ixOmax1,ixOmin2:ixOmax2))
    ...
    case(3)
      ...
      do i = ixBmax2, ixBmin2, -1
        ...
        do j = ixImin2,ixImax2
          w(ixImin1:ixImax1,i,mom(2)) = min(1.5d0, w(ixImin1:ixImax1,i,&
             mom(2)))
          w(ixImin1:ixImax1,i,mom(2)) = max(-1.0d0, w(ixImin1:ixImax1,i,&
             mom(2)))
        enddo
        ...
        do j = ixImin2,ixImax2
          w(ixImin1:ixImax1,i,r_e) = min(1.5d0*sp_Er, w(ixImin1:ixImax1,i,&
             r_e))
          w(ixImin1:ixImax1,i,r_e) = max(0.5d0*sp_Er, w(ixImin1:ixImax1,i,&
             r_e))
        enddo
      enddo
