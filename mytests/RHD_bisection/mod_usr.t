...
!> internal boundary, user defined
  ...
  subroutine constant_r_e(level,qt,ixI^L,ixO^L,w,x)
    ...
    double precision :: delta_Er, delta_eg

    delta_Er = (w(3,3,r_e) - Er_equib)/Er_equib
    delta_eg = (w(3,3,e_) - eg_equib)/eg_equib
    ...
    if (mod(it,100) .eq. 0.d0) &
    write(1,*) global_time, Er_equib, eg_equib, w(3,3,r_e), w(3,3,e_)&
    , delta_Er, delta_eg, Trad, Tgas, w(3,3,r_e) + w(3,3,e_)
