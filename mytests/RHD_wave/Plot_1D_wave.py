...
# x0 , rho_Euler, v_Euler, e_Euler, E_Euler = get_data('convergence/Euler_mp5_8000100.blk')
# x0 , rho_SP, v_SP, e_SP, E_SP = get_data('convergence/SP_weno5_8000100.blk')
# x0 , rho_Midpoint, v_Midpoint, e_Midpoint, E_Midpoint = get_data('convergence/Midpoint_weno5_8000100.blk')
# x0 , rho_ARS3, v_ARS3, e_ARS3, E_ARS3 = get_data('convergence/ARS3_weno5_8000100.blk')
