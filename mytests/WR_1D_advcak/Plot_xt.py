...
# plt.pcolor(t_mesh,x_mesh,np.log10(All_E),cmap='viridis',vmin=-6,vmax=-4)
plt.pcolor(t_mesh,x_mesh,np.log10(All_E/mmean_E),cmap='seismic',vmin=-0.5,vmax=0.5)
# plt.pcolor(t_mesh,x_mesh,All_E,cmap='viridis',vmin=0,vmax=0.0002)

cbar = plt.colorbar()
cbar.set_label('$Log(\dot{M})$')
