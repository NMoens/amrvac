...
!      T_out = max(4.2d4/unit_temperature, T_out)
  ...
  subroutine PseudoPlanar(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    double precision :: k_cak(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1:ndim),&
    ...
    if (.not. Cak_in_D) then
      if (read_cak_table) then
        call get_kappa_CAK2(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
           ixOmax1,ixOmax2,wCT,x,k_cak(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1),1)
        call get_kappa_CAK2(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
           ixOmax1,ixOmax2,wCT,x,k_cak(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2),2)
      else
      ...
      if (fixed_lum) then
        ...
        w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,mom(1)) = w(ixOmin1:ixOmax1,&
           ...
           1)/const_c*k_cak(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1)*unit_velocity
        if (rhd_energy) then
          w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,e_) = w(ixOmin1:ixOmax1,&
             ixOmin2:ixOmax2,e_) + qdt*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
  ...
  subroutine get_dt_cak(w,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    if (read_cak_table) then
      call get_kappa_CAK2(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2,w,x,k_cak(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1),1)
      call get_kappa_CAK2(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2,w,x,k_cak(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2),2)
    else
      call get_kappa_CAK(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2,w,x,k_cak(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1),1)
      call get_kappa_CAK(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    if (fixed_lum) then
      ...
      dt_cak = courantpar*minval(dsqrt(dxlevel(1)/(L_bound/(4*dpi*x(&
         ...
         ixOmin2:ixOmax2,1)*unit_velocity -const_G*mass/radius(ixImin1:ixImax1,&
         ixImin2:ixImax2)**2*(unit_time**2/unit_length))))
    else
      !> Local flux
      ...
      dt_cak = courantpar*minval(dsqrt(dxlevel(1)/abs(rad_flux(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,1)/const_c*k_cak(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         1)*unit_velocity -const_G*mass/radius(ixImin1:ixImax1,&
         ixImin2:ixImax2)**2*(unit_time**2/unit_length))))
    endif
  ...
  subroutine OPAL_and_CAK(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
     ixOmax1,ixOmax2,w,x,kappa, idir)
    use mod_physics, only: phys_get_trad
    use mod_global_parameters
    use mod_opal_opacity
    use mod_afld
  ...
  subroutine get_kappa_CAK(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    vel(ixImin1:ixImax1,ixImin2:ixImax2) = w(ixImin1:ixImax1,ixImin2:ixImax2,&
       mom(idir))/w(ixImin1:ixImax1,ixImin2:ixImax2,rho_)
    call gradientO(vel,x,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
       ixOmax1,ixOmax2,idir,gradv,nghostcells)
  ...
  subroutine kappa_qdot(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
     ixOmax1,ixOmax2,w,x,kappa)
    use mod_physics, only: phys_get_trad, phys_get_tgas
    use mod_global_parameters
    use mod_cak_opacity
    ...
    call OPAL_and_CAK(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,ixOmax1,&
       ixOmax2,w,x,kappa, 1)
 ...
 subroutine ceil_diffcoef(w, wCT, x, ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
    ...
    where (w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       i_diff_mg(1)) .gt. 1.5d3) w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       i_diff_mg(1)) = 1.5d3
    where (w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       i_diff_mg(2)) .gt. 1.5d3) w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       i_diff_mg(2)) = 1.5d3

    where (w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       i_diff_mg(1)) .lt. 1.d-2) w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       i_diff_mg(1)) = 1.d-2
    where (w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       i_diff_mg(2)) .lt. 1.d-2) w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       i_diff_mg(2)) = 1.d-2
  ...
  subroutine collapse_to_1D()
    ...
    do iigrid=1,igridstail; igrid=igrids(iigrid);
      ...
      call afld_get_radflux(block%w, block%x, ixGlo1,ixGlo2,ixGhi1,ixGhi2,&
  ...
  subroutine update_extravars(igrid,level,ixImin1,ixImin2,ixImax1,ixImax2,&
    ...
    double precision                   :: kappa(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,1:ndim), OPAL(ixOmin1:ixOmax1,ixOmin2:ixOmax2),&
        CAK(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1:ndim)
    double precision                   :: vel(ixImin1:ixImax1,ixImin2:ixImax2),&
    ...
    double precision                   :: pp_rf(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2), lambda(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1:ndim),&
        fld_R(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1:ndim), gradOE(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2)
    integer                            :: idim
    double precision :: radius(ixImin1:ixImax1,ixImin2:ixImax2)
    double precision :: mass
    ...
    if (read_cak_table) then
      call get_kappa_CAK2(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2,w,x,CAK(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1),1)
      call get_kappa_CAK2(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2,w,x,CAK(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2),2)
    else
      call get_kappa_CAK(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2,w,x,CAK(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1),1)
      call get_kappa_CAK(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    g_rad(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = (OPAL(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2)+CAK(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       1))*rad_flux(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1)/(const_c/unit_velocity)
    ...
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,i_CAK1) = CAK(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,1)/kappa_e
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,i_CAK2) = CAK(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,2)/kappa_e
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,i_lambda1) = lambda(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,1)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,i_lambda2) = lambda(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,2)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,i_Edd) = lambda(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,1) + lambda(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       1)**2 * fld_R(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1)**2
