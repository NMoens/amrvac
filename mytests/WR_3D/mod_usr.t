  ...
  subroutine boundary_conditions(qt,ixI^L,ixB^L,iB,w,x)
    ...
    case(1)
      ...
      do ix1 = ixImin1,ixImax1
        Local_gradE(ix1,ixBmin2:ixBmax2,ixBmin3:ixBmax3) = -(F_bound-F_adv)/w(nghostcells+1,ixBmin2:ixBmax2,ixBmin3:ixBmax3,i_diff_mg)
      enddo
      gradE = sum(Local_gradE(nghostcells,ixBmin2:ixBmax2,ixBmin3:ixBmax3))/((ixBmax2-ixBmin2)*(ixBmax3-ixBmin3))

      do ix1 = ixBmax1,ixBmin1,-1
        w(ix1,ixBmin2:ixBmax2,ixBmin3:ixBmax3,r_e) = w(ix1+2,ixBmin2:ixBmax2,ixBmin3:ixBmax3,r_e) &
        + (x(ix1,ixBmin2:ixBmax2,ixBmin3:ixBmax3,1)-x(ix1+2,ixBmin2:ixBmax2,ixBmin3:ixBmax3,1))*Local_gradE(ix1+1,ixBmin2:ixBmax2,ixBmin3:ixBmax3)
      enddo
