...
ax1.semilogy(y_rel, rho_rel1,'o', label = 'Final full diffusion')
ax1.semilogy(y_rel, rho_rel2,'o', label = 'Final Pomraning')
...
ax2.plot(y_rel, rho_p_2_T(rho_rel2,p_rel2),'o')
...
ax3.plot(y_rel, E_r_2_T(er_rel2),'o')
...
# plt.plot(y_rel,F_rel1,label='Averaged full diffusion')
# plt.plot(y_rel,F_rel2,label='Averaged Pomraning')
...
plt.plot(y_vac[1:],F_2_Gamma(flux_vac),label='initial amrvac profile')
# plt.plot(y_it[1:],F_2_Gamma(flux_it,rho_it),label='iterated profile')
plt.plot(y_rel[1:],F_2_Gamma(F_rel1[1:]),label='Averaged full diffusion')
plt.plot(y_rel[1:],F_2_Gamma(F_rel2[1:]),label='Averaged Pomraning')
plt.legend()
