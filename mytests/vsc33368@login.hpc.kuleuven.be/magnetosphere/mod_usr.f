...
subroutine time_average_values(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
  ...
  if (global_time .gt. 0.5d0) then
    w(ixImin1:ixImax1,ixImin2:ixImax2,int_r2v) = w(ixImin1:ixImax1,&
       ixImin2:ixImax2,int_r2v) + w(ixImin1:ixImax1,ixImin2:ixImax2,&
       mom(1))*w(ixImin1:ixImax1,ixImin2:ixImax2,rho_)*dt
    w(ixImin1:ixImax1,ixImin2:ixImax2,int_r2) = w(ixImin1:ixImax1,&
       ixImin2:ixImax2,int_r2) + w(ixImin1:ixImax1,ixImin2:ixImax2,&
       rho_)**two*dt
    w(ixImin1:ixImax1,ixImin2:ixImax2,int_v2) =  w(ixImin1:ixImax1,&
       ixImin2:ixImax2,int_v2) + w(ixImin1:ixImax1,ixImin2:ixImax2,&
       mom(1))**two/w(ixImin1:ixImax1,ixImin2:ixImax2,rho_)**two*dt
    ...
    w(ixImin1:ixImax1,ixImin2:ixImax2,int_r2v) = zero
    w(ixImin1:ixImax1,ixImin2:ixImax2,int_r2) = zero
    w(ixImin1:ixImax1,ixImin2:ixImax2,int_v2) = zero
